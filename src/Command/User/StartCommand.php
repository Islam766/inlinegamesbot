...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= __('Для начала начните сообщение с {USAGE} в любом из ваших чатов или нажмите {BUTTON} кнопку, а затем выберите чат, в котором хотите играть.', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
